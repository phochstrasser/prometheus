...
// configuration step. It creates a namespace called `prometheus`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", prometheus::cmake::project_name, prometheus::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", prometheus::cmake::project_version);
      return EXIT_SUCCESS;
    }
